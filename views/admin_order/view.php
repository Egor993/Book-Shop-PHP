...
<?php include ROOT.'/views/include/admin_header.php'; ?>
  ...
  <fieldset class="module aligned ">
            ...
            <table >
                <tr>
                    <td><h3>Номер заказа</h3></td>
                    <td><h3><h3><?php echo $order['id']; ?></h3></td>
                </tr>
                <tr>
                    <td><h3>Имя клиента</td>
                    <td><h3><?php echo $order['user_name']; ?></td>
                </tr>
                <tr>
                    <td><h3>Телефон клиента</td>
                    <td><h3><?php echo $order['user_phone']; ?></td>
                </tr>
                <tr>
                    <td><h3>Комментарий клиента</td>
                    <td><h3><?php echo $order['user_comment']; ?></td>
                </tr>
                <?php if ($order['user_id'] != 0): ?>
                    <tr>
                        <td><h3>ID клиента</td>
                        <td><h3><?php echo $order['user_id']; ?></td>
                    </tr>
                <?php endif; ?>
                <tr>
