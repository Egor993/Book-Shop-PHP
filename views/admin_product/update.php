        ...
        <div> 
                <div>
                        ...
                        <label class="required" for="id_title">Название:</label>
                            ...
                            <input type="text" name="name" class="vTextField" maxlength="100" required id="id_title" value='<?php echo $product['name'];?>'>
        ...
        <div> 
                <div>
                        ...
                        <label class="required" for="id_title">Автор:</label>
                            ...
                            <input type="text" name="author" class="vTextField" maxlength="100" required id="id_title" value='<?php echo $product['author'];?>'>
        ...
        <div class="form-row field-description">
                ...
                <div>
                        ...
                        <label class="required" for="id_description">Описание:</label>
                            ...
                            <textarea name="description" cols="60" rows="10"  required id="id_description"><?php echo $product['name'];?>
</textarea>
        ...
        <div class="form-row field-price">
                ...
                <div>
                        ...
                        <label class="required" for="id_price">Цена:</label>
                            ...
                            <input type="number" name="price" value='<?php echo $product['price'];?>' class="vIntegerField"required id="id_price" >
